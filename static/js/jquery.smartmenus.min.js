            ...
            prototype: {
                            ...
                            .bind(
                                s(
                                    [
                                        [
                                            "mouseover focusin",
                                            t.proxy(this.rootOver, this)
                                        ],
                                        [
                                            "mouseout focusout",
                                            t.proxy(this.rootOut, this)
                                        ],
                                        [
                                            "keydown",
                                            t.proxy(this.rootKeyDown, this)
                                        ]
                                    ],
                                    r
                                )
                            ...
                            .delegate(
                                ...
                                s(
                                    [
                                        [
                                            "mouseenter",
                                            t.proxy(this.itemEnter, this)
                                        ],
                                        [
                                            "mouseleave",
                                            t.proxy(this.itemLeave, this)
                                        ],
                                        [
                                            "mousedown",
                                            t.proxy(this.itemDown, this)
                                        ],
                                        [
                                            "focus",
                                            t.proxy(this.itemFocus, this)
                                        ],
                                ...
                                t(document).bind(
                                    s(
                                        [
                                            ...
                                            [
                                                "touchmove",
                                                t.proxy(this.docTouchMove, this)
                                            ],
                                            [
                                                "touchend",
                                                t.proxy(this.docTouchEnd, this)
                                            ],
                                            [
                                                "click",
                                                t.proxy(this.docClick, this)
                                            ]
                                        ],
                                        r
                                    )
                        ...
                        .each(function () {
                            ...
                            i.dataSM("scroll-arrows") &&
                                ...
                                i.dataSM("shown-before") &&
                                    ((s.opts.subMenusMinWidth ||
                                        s.opts.subMenusMaxWidth) &&
                                        i
                                            .css({
                                                width: "",
                                                minWidth: "",
                ...
                getOffset: function (t, i) {
                    ...
                    return (
                        o ||
                            0 === o ||
                            (o = i ? t[0].offsetHeight : t[0].offsetWidth),
                        e && t.hide().css(e),
                        o
                    );
                },
                getStartZIndex: function (t) {
                    ...
                    return (
                        !t &&
                            isNaN(i) &&
                            (i = parseInt(this.$root.css("z-index"))),
                        isNaN(i) ? 1 : i
                    );
                },
                ...
                itemActivate: function (i, e) {
                    ...
                    if (
                        ...
                        this.$root.triggerHandler("activate.smapi", i[0]) !==
                            !1)
                    ) {
                        var r = i.dataSM("sub");
                        r &&
                ...
                menuHide: function (i) {
                    if (
                        this.$root.triggerHandler("beforehide.smapi", i[0]) !==
                            !1 &&
                ...
                menuPosition: function (i) {
                    ...
                    if (
                        (T
                            ? ((e = $ ? f - l - y : y),
                              (o = this.opts.bottomToTopSubMenus
                                  ? -c - I
                                  : v + I))
                            : ((e = $ ? y - l : f - y),
                              (o = this.opts.bottomToTopSubMenus
                        ...
                        if (
                            ...
                            i
                                ...
                                .css({
                                    ...
                                    marginLeft:
                                        e +
                                        (parseInt(i.css("border-left-width")) ||
                                            0),
                                    width:
                                        l -
                                        (parseInt(i.css("border-left-width")) ||
                ...
                menuScrollOut: function (i, e) {
                    r &&
                        (/^scroll-(up|down)/.test(
                            ...
                            ((i[0] == e.relatedTarget ||
                                t.contains(i[0], e.relatedTarget)) &&
                ...
                menuScrollOver: function (i, e) {
                    if (
                        ...
                        i.dataSM("scroll-arrows")
                            ...
                            .css(
                                "margin-top",
                                o + this.getViewportHeight() - s.arrowDownH
                            )
                            .end()
                ...
                menuScrollRefreshData: function (i) {
                    var e = i.dataSM("scroll"),
                        s =
                            ...
                            e.itemH;
                    this.cssTransforms3d &&
                        (s = -(parseFloat(i.css("margin-top")) - s)),
                        t.extend(e, {
                            upEnd: s,
                ...
                menuShow: function (t) {
                    if (
                        ...
                        this.$root.triggerHandler("beforeshow.smapi", t[0]) !==
                            !1 &&
                        (t.dataSM("shown-before", !0).stop(!0, !0),
                        !t.is(":visible"))
                    ) {
                        var i = t.dataSM("parent-a");
                        if (
                            ((this.opts.keepHighlighted ||
                                this.isCollapsible()) &&
                            ...
                            this.menuPosition(t),
                                t.dataSM("ie-shim") &&
                                    t.dataSM("ie-shim").insertBefore(t);
                        }
                        var s = function () {
                            t.css("overflow", "");
                        };
