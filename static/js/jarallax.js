    ...
    /******/ [
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            (0, _liteReady2.default)(function () {
                (0,
                _jarallax2.default)(document.querySelectorAll("[data-jarallax]"));
            });
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            /* WEBPACK VAR INJECTION */ (function (global) {
                ...
                function updateWndVars(e) {
                    wndW =
                        _global.window.innerWidth ||
                        document.documentElement.clientWidth;
                    wndH =
                        _global.window.innerHeight ||
                ...
                var Jarallax = (function () {
                    function Jarallax(item, userOptions) {
                        ...
                        var oldDataOptions = JSON.parse(
                            deprecatedDataAttribute || "{}"
                        );
                        ...
                        Object.keys(dataOptions).forEach(function (key) {
                            ...
                            if (
                                loweCaseOption &&
                                typeof self.defaults[loweCaseOption] !==
                                    "undefined"
                            ) {
                                pureDataOptions[loweCaseOption] =
                                    dataOptions[key];
                            }
                        });
                        ...
                        if (self.options.disableParallax instanceof RegExp) {
                            var disableParallaxRegexp =
                                self.options.disableParallax;
                            self.options.disableParallax = function () {
                                return disableParallaxRegexp.test(
                                    navigator.userAgent
                                );
                            };
                        }
                        if (
                            typeof self.options.disableParallax !== "function"
                        ) {
                            self.options.disableParallax = function () {
                                return false;
                            };
                        ...
                        if (self.options.disableVideo instanceof RegExp) {
                            ...
                            self.options.disableVideo = function () {
                                return disableVideoRegexp.test(
                                    navigator.userAgent
                                );
                            };
                        }
                    ...
                    _createClass(Jarallax, [
                        ...
                        },
                        {
                            ...
                            value: function extend(out) {
                                ...
                                Object.keys(arguments).forEach(function (i) {
                                    ...
                                    Object.keys(_arguments[i]).forEach(
                                        function (key) {
                        ...
                        },
                        {
                            ...
                            value: function initImg() {
                                ...
                                return !(
                                    !self.image.src || self.image.src === "none"
                                );
                            }
                        },
                        {
                        ...
                        },
                        {
                            ...
                            value: function init() {
                                ...
                                if (
                                    self.css(self.$item, "z-index") === "auto"
                                ) {
                                    self.css(self.$item, {
                                        zIndex: 0
                                    });
                                ...
                                self.image.$container.appendChild(
                                    self.image.$item
                                );
                                ...
                                if (
                                    self.css(self.$item, "background-image") !==
                                    "none"
                                ) {
                                    self.css(self.$item, {
                            ...
                            value: function destroy() {
                                ...
                                if (self.image.useImgTag) {
                                    ...
                                    if (self.image.$itemParent) {
                                        self.image.$itemParent.appendChild(
                                            self.image.$item
                                        );
                                    }
                                }
                                ...
                                if (self.$clipStyles) {
                                    self.$clipStyles.parentNode.removeChild(
                                        self.$clipStyles
                                    );
                                }
                        ...
                        },
                        {
                            ...
                            value: function clipContainer() {
                                ...
                                var self = this;
                                var rect =
                                    self.image.$container.getBoundingClientRect();
                                ...
                                if (self.$clipStyles.styleSheet) {
                                    self.$clipStyles.styleSheet.cssText =
                                        styles;
                                } else {
                            ...
                            value: function onScroll(force) {
                                ...
                                if (
                                    ...
                                    if (self.options.speed < 0) {
                                        scale -=
                                            self.options.speed * visiblePercent;
                                    } else {
                                        scale +=
                                            self.options.speed *
                                            (1 - visiblePercent);
